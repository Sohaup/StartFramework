...
export default function About() {
  return (
     <section className='d-flex flex-column align-items-center justify-content-center gap-3   w-75 mx-auto '>            
            <div className="details text-light text-center ">
                <h1 className='header display-5 fw-bolder'>
                    About component
                    <i className='fa fa-star fs-5'></i>
                </h1>
                <p className='fs-6 fw-bold d-flex flex-column flex-lg-row gap-3 py-3 text-start'>
                    <span>
